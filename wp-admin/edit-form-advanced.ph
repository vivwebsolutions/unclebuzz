...
<div id="helpmeta">
<h2>Directions</h2>
<p><strong>Follow a few easy steps to publish your post.  Keep in mind all content should be original and topical.</strong></p>
<table cellspacing="0" id="steps">
 <tr>
  <td><span class="nummba">1</span></td>
    <td>Enter the title of your post. You <strong>must</strong> add the title before adding other information.</td>
  </tr>
 <tr>
  <td><span class="nummba">2</span></td>
    <td>Add your description in the box below. Then add the location and the date of your video recording.</td>
  </tr>
 <tr>
  <td><span class="nummba">3</span></td>
    <td><a href="http://upload.youtube.com/my_videos_upload" target="_blank">Upload your <strong>original video</strong> to Youtube.</a> (you will need  to make an account if you don’t have one)</td>
  </tr>
 <tr>
  <td><span class="nummba">4</span></td>
    <td>Simply copy the url of your movie (e.g. http://www.youtube.com/watch?v=HRSnqLFPQ2) and paste it into the<strong> Video URL</strong> field. Then hit the <strong>Update Post</strong> button.</td>
  </tr>
 <tr>
  <td><span class="nummba">5</span></td>
    <td><strong>Add a thumbnail.</strong>
    The thumbnail image is the small image that previews your video in a small size. To see the thumbnail of your newly uploaded video you need to go to “my videos” on Youtube. Right click the thumbnail image of your video on Youtube and select Copy Image Location. Paste the URL into the <strong>Upload via URL</strong> field of the <strong>Post Thumbnail Options</strong> box. Alternatively, you can download or create a thumbnail and upload it from your machine by clicking on the <strong>Browse</strong> button. Then hit the <strong>Update Post</strong> button again.
  </tr>
 <tr>
  <td><span class="nummba">6</span></td>
    <td><strong>Categorize and tag your post. </strong>In the right hand column you'll see additional options, these include <strong>Categories</strong> and <strong>Tags</strong>.  Find a suitable category for your story and tick the checkbox next to it. You need to select at least one category. You can publish your post  in multiple categories. Defining tags is optional but it helps other users find your story. </td>
  </tr>
 <tr>
  <td><span class="nummba">7</span></td>
    <td>When you are done editing your post hit the <strong>Publish</strong> button. Before you do so, it is recommended that you save a draft and preview your post and do a spell check since once a post is submitted, you can  no longer edit it. </td>
  </tr>
 <tr>
  <td>&nbsp;</td>
    <td><br />(If you want to add a picture instead, You add a picture by clicking the first <span class="imgup">icon</span> in the toolbar. You must upload your photos to a third party hosting provider (like flick or Picasa), since we do not  host them. Please provide a link to your image file in the <strong>Image URL</strong> field. The maximum allowed image width is 620px. The image resolution should not exceed 72 dpi.)</td>
  </tr>
</table>
</div>
