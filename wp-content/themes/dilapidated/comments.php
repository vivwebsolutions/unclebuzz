...
<br/><br/>
<h3 id="respond"><?php comment_form_title( 'Leave a Reply', 'Leave a Reply to %s' ); ?></h3></p>
...
<p><div class="left"><?php if (function_exists('show_subscription_checkbox')) { show_subscription_checkbox(); } ?></div>
